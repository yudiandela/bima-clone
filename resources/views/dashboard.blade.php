    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="flex justify-center gap-5 -mt-8">
                <a wire:navigate href="{{ route('penelitian.usulan-baru') }}" class="flex items-center gap-3 px-10 py-5 text-xl font-bold text-center text-blue-800 transition-all duration-300 bg-white rounded shadow hover:bg-blue-800 hover:text-white">
